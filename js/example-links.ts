...
<p style="margin-top: 15px;">Python 3 only: 
<a class="exampleLink" id="tortureLink" href="#">student torture</a> |
<a class="exampleLink" id="nonlocalLink" href="#">nonlocal</a>
</p>

<p style="margin-top: 15px;" >Error Handling:

<a class="exampleLink" id = "thirty_callsLink" href="#">30 Calls</a> |
<a class="exampleLink" id = "two_MBLink" href="#">2 MB</a> 
</p>
`;
...
export var PY2_EXAMPLES = {
  ...
  thirty_callsLink: "thirty_calls.txt",
  // ten_SecondsLink: "ten_Seconds.txt",
  two_MBLink: "two_MB.txt",
  numpyLink: "numpy.txt",
};
